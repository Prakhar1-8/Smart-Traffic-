...
export default function Profile() {
  ...
  return (
    <div className="p-6 text-foreground max-w-4xl mx-auto space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold">User Identity Matrix</h1>
          <p className="text-sm text-foreground/60 mt-1">Manage your centralized administrative profile metrics globally.</p>
        </div>
        {!isEditing ? (
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="col-span-1 border border-border bg-card rounded-xl p-6 flex flex-col items-center text-center space-y-4">
          <div className="w-24 h-24 rounded-full bg-primary/20 flex items-center justify-center shadow-lg ring-1 ring-primary/40">
        ...
        <div className="col-span-1 md:col-span-2 border border-border bg-card rounded-xl p-6 space-y-6">
          <h3 className="text-lg font-semibold border-b border-border pb-3">Personal Parameters</h3>
